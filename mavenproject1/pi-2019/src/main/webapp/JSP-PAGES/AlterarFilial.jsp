    ...
    <body id="body-changes" class="text-center">
        <form name="formCad" id="FadeForm" class="form-type" method="post" action="${pageContext.request.contextPath}/AlterarFilial" accept-charset="UTF-8">
            ...
            <div class="row justify-content-center">
                <div class="form-group col-6 ">
                    <label> CNPJ: </label>
                    <input type="number" class="form-control" placeholder="CNPJ" required name="CNPJ" id="CNPJ" onkeypress="return onlynumber();" maxlength="14" value="${filial.CNPJ}">
                </div>
                <div class="form-group col-6 ">
                    <label> Razão: </label>
                    <input type="text" class="form-control" placeholder="razao" required name="razao" id="razao" value="${filial.razao}">
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="form-group col-4 ">
                    <label> CEP: </label>
                    <input type="text" class="form-control" placeholder="00000-000" required name="cep" id="cep" onkeypress="return onlynumber();"value="${filial.CEP}">
                </div>
                <div class="form-group col-4 ">
                    <label> Cidade: </label>
                ...
                <div class="form-group col-4">
                    ...
                    <select class="form-control" name="estado" id="estado" required>
                        <option selected value="${filial.estado}">${filial.estado}</option>
            ...
            <div class="row justify-content-center">
                <div class="form-group col-8 ">
                    ...
                    <input type="text" class="form-control" placeholder="1234 Main St" name="endereco" id="endereco" required value="${filial.endereco}">
                </div>
                <div class="form-group col-4">
                    <label> Complemento: </label>
                    <input type="text" class="form-control" placeholder="Apartament" name="complemento" id="complemento" required value="${filial.complemento}">
                </div>
            </div>
            <div class="">
                <div class="form-group col-3">
                    <label> Contato: </label>
                    <input type="text" class="form-control" placeholder="(00)0000-00000" name="contato" id="contato" required onkeypress="return onlynumber();" value="${filial.contato}">
                </div>
            </div>
            <div class="row ">
